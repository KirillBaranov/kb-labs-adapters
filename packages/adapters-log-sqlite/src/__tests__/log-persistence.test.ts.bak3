...
import { LogSQLitePersistence } from '../index.ts';
...
describe('LogSQLitePersistence', () => {
  ...
  describe('query', () => {
    ...
    it('should sort by timestamp ascending', async () => {
      const result = await persistence.query({}, { sortBy: 'timestamp', sortOrder: 'asc' });
  ...
  describe('search', () => {
    ...
    it('should search logs by text', async () => {
      ...
      expect(result.logs).toHaveLength(2);
      expect(result.logs.every((l) => l.message.includes('authentication'))).toBe(true);
    });
  ...
  describe('deleteOlderThan', () => {
    beforeEach(async () => {
      const logs: LogRecord[] = [
        { timestamp: 1000, level: 'info', message: 'Old log 1', fields: {}, source: 'test' },
        { timestamp: 2000, level: 'info', message: 'Old log 2', fields: {}, source: 'test' },
        { timestamp: 5000, level: 'info', message: 'New log 1', fields: {}, source: 'test' },
        { timestamp: 6000, level: 'info', message: 'New log 2', fields: {}, source: 'test' },
      ];
  ...
  describe('getStats', () => {
    ...
    it('should return correct stats', async () => {
      const logs: LogRecord[] = [
        { timestamp: 1000, level: 'info', message: 'Log 1', fields: {}, source: 'test' },
        { timestamp: 2000, level: 'info', message: 'Log 2', fields: {}, source: 'test' },
        { timestamp: 3000, level: 'info', message: 'Log 3', fields: {}, source: 'test' },
      ];
  ...
  describe('edge cases', () => {
    ...
    it('should handle special characters in message', async () => {
      const specialMessage = "Test with 'quotes' and \"double quotes\" and \n newlines \t tabs";
